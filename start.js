...
if (!process.env.TEMP_DIRECTORY) {
  process.env.TEMP_DIRECTORY = join(process.env.APP_DATA_DIRECTORY, "temp");
}
if (!existsSync(process.env.TEMP_DIRECTORY)) {
  mkdirSync(process.env.TEMP_DIRECTORY, { recursive: true });
}
